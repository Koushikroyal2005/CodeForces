...
void solve(){
    ...
    int2(l3,b3);
    bool flag=0;
    if (b1 == b2 && l1 + l2 == l3 && b1 + b3 == l3) flag=1;
    if (b1 == b3 && l1 + l3 == l2 && b1 + b2 == l2) flag=1;
    if (b2 == b3 && l2 + l3 == l1 && b2 + b1 == l1) flag=1;
    if (l2 == l3 && b2 + b3 == b1 && l1 + l2 == b1) flag=1;
    if (l1 == l3 && b1 + b3 == b2 && l2 + l1 == b2) flag=1;
    if (l1 == l2 && b1 + b2 == b3 && l3 + l1 == b3) flag=1;
    if (b1 == b2 && b2 == b3 && l1 + l2 + l3 == b1) flag=1;
    if (l1 == l2 && l2 == l3 && b1 + b2 + b3 == l1) flag=1;
    if (l1 + l2 == l3 && b1 == b2 && b3 + b1 == l3) flag=1;
    if (l1 + l3 == l2 && b1 == b3 && b2 + b1 == l2) flag=1;
    if (l2 + l3 == l1 && b2 == b3 && b1 + b2 == l1) flag=1;
    if ((b1 + b2 == b3) && l1 == l2 && l1 + l3 == b3) flag=1;
    if ((b1 + b3 == b2) && l1 == l3 && l1 + l2 == b2) flag=1;
    if ((b2 + b3 == b1) && l2 == l3 && l2 + l1 == b1) flag=1;
    if (b1 == b2 && b2 == b3 && l1 + l2 + l3 == b1) flag=1;
    if (l1 == l2 && l2 == l3 && b1 + b2 + b3 == l1) flag=1;
    if(flag) YES;
    else NO;
